...
function carrito() {
    ...
    checkoutCart: function(products, totalPrice, totalQuantity) {
      ...
      $('head').append('<link rel="stylesheet" href="/assets/css/sections/sectionCheckout.css" />');
      $.post('/checkout/confirm.php', {
      	products: products,
